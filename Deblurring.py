...
from model.MIMO_plus import get_model
...
model = get_model(input_shape=(128, 128, 1), f = 64, num_res = 6)
print(model.summary())


##Load losses and complie the model
...
def loss_func(y_true, y_pred):
    """Content loss based on VGG19 model"""
...
C = [
    tf.keras.callbacks.CSVLogger('MIMO_l1.csv', append=True), 
    tf.keras.callbacks.ModelCheckpoint('MIMO_l1.h5', save_best_only=True, verbose=1), 
