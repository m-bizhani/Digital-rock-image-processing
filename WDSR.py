...
model = wdsr_a(scale=2, num_filters=128, 
                num_res_blocks=8, 
...
C = [
    tf.keras.callbacks.CSVLogger('WDSR-l1.csv', append=True), 
    tf.keras.callbacks.ModelCheckpoint('WDSR-l1.h5', save_best_only=True, verbose=1), 
